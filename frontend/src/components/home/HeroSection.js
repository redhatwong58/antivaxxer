 ...
 *
 * Logo: uses /images/logo.png if available, falls back to text.
 * Replace logo by swapping the file in public/images/logo.png.
    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 text-center px-10">
        <div className="animate-hero">
          {/* Logo — swap public/images/logo.png to replace */}
          <img src="/images/logo.png" alt="ANTIVAXXER"
